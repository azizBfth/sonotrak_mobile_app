...
class MenuWidget extends StatelessWidget {
  final menuItems = ['Home', 'Devices', 'Consumption', 'Contributions', 'Reports', 'Maintenance', 'Logout'];
  ...
  Widget build(BuildContext context) {
    return currentMenuPercent != 0 
        ? Positioned(
            left: realW(-358 + 358 * (currentMenuPercent as double)),
            width: realW(358),
            height: screenHeight,
            child: Opacity(
              opacity: currentMenuPercent as double,
              child: Container(
